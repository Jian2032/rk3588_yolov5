...
/**
* @brief 向作业文件插入一条轴运动控制指令
* @param moveCmd  指令参数
* @param id 工艺号参数
* @param line 插入的位置
*/
Result job_insert_axis_motion(SOCKETFD socketFd, int line, MoveCmd moveCmd);
Result job_insert_axis_motion_rbobt(SOCKETFD socketFd, int robotNum, int line, MoveCmd moveCmd);
